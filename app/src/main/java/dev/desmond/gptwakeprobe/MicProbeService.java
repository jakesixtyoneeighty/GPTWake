...
public class MicProbeService extends Service {

    private static final String CH = "probe_mic";
        ...
        if (!FOREGROUND.get()) {
            try {
                ...
                nm.createNotificationChannel(
                        new NotificationChannel(CH, "Probe mic", NotificationManager.IMPORTANCE_LOW));
                Notification n = new Notification.Builder(this, CH)
                        .setContentTitle("GPTWakeProbe listening")
